...
public abstract class MicroService implements Runnable {
    ...
    protected boolean terminated = false; //I changed all fields to protected
    protected final String name;
    protected final MessageBusImpl messageBus;
    protected HashMap<Class<? extends Message>, Callback> CallBackMap;
    protected List<Class<? extends Message>> listOfTypes;

    public List<Class<? extends Message>> getListOfTypes() {
        return listOfTypes;
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback toDo = CallBackMap.get(message.getClass());
                toDo.call(message);
